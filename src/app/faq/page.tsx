      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="space-y-4">
          ...
          <FaqItem
            ...
            a="$14.99 per letter for 1-3 letters, $12.99 for 4-6, $10.99 for 7-9, and $9.50 for 10+. The longer the word, the better the deal. Custom colours are a one-time $5 fee."
          />
          <FaqItem
